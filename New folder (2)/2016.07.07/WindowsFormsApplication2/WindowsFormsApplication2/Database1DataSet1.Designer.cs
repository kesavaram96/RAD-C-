...
namespace WindowsFormsApplication2.Database1DataSet1TableAdapters {
    ...
    public partial class TableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Table] WHERE (([StudentId] = @Original_StudentId) AND ([Age] =" +
                " @Original_Age))";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Table] SET [StudentId] = @StudentId, [StudentName] = @StudentName, " +
                "[Age] = @Age WHERE (([StudentId] = @Original_StudentId) AND ([Age] = @Original_A" +
                "ge));\r\nSELECT StudentId, StudentName, Age FROM [Table] WHERE (StudentId = @Stude" +
                "ntId)";
        ...
        public virtual int Delete(int Original_StudentId, int Original_Age) {
        ...
        public virtual int Insert(int StudentId, string StudentName, int Age) {
        ...
        public virtual int Update(int StudentId, string StudentName, int Age, int Original_StudentId, int Original_Age) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string StudentName, int Age, int Original_StudentId, int Original_Age) {
