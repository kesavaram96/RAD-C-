...
namespace WindowsFormsApplication1 {
    ...
    public partial class Database1DataSet1 : global::System.Data.DataSet {
        ...
        public partial class TableDataTable : global::System.Data.TypedTableBase<TableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public TableRow AddTableRow(int StudentID, string StudentName, int Age) {
...
namespace WindowsFormsApplication1.Database1DataSet1TableAdapters {
    ...
    public partial class TableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Table] ([StudentID], [StudentName], [Age]) VALUES (@StudentID," +
                " @StudentName, @Age);\r\nSELECT StudentID, StudentName, Age FROM [Table] WHERE (St" +
                "udentID = @StudentID)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Table] SET [StudentID] = @StudentID, [StudentName] = @StudentName, [Age] = @Age WHERE (([StudentID] = @Original_StudentID) AND ((@IsNull_Age = 1 AND [Age] IS NULL) OR ([Age] = @Original_Age)));
SELECT StudentID, StudentName, Age FROM [Table] WHERE (StudentID = @StudentID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT StudentID, StudentName, Age FROM dbo.[Table]";
        ...
        public virtual int Insert(int StudentID, string StudentName, global::System.Nullable<int> Age) {
        ...
        public virtual int Update(int StudentID, string StudentName, global::System.Nullable<int> Age, int Original_StudentID, global::System.Nullable<int> Original_Age) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string StudentName, global::System.Nullable<int> Age, int Original_StudentID, global::System.Nullable<int> Original_Age) {
            return this.Update(Original_StudentID, StudentName, Age, Original_StudentID, Original_Age);
        }
    }
