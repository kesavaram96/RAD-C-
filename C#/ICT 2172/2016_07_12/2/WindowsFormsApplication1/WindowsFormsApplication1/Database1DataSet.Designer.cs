...
namespace WindowsFormsApplication1 {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class TableDataTable : global::System.Data.TypedTableBase<TableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public TableRow AddTableRow(int StudentId, int Age, string Address) {
...
namespace WindowsFormsApplication1.Database1DataSetTableAdapters {
    ...
    public partial class TableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Table] WHERE (([StudentId] = @Original_StudentId) AND ((@IsNul" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Table] ([StudentId], [Age], [Address]) VALUES (@StudentId, @Ag" +
                "e, @Address);\r\nSELECT StudentId, Age, Address FROM [Table] WHERE (StudentId = @S" +
                "tudentId)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Table] SET [StudentId] = @StudentId, [Age] = @Age, [Address] = @Address WHERE (([StudentId] = @Original_StudentId) AND ((@IsNull_Age = 1 AND [Age] IS NULL) OR ([Age] = @Original_Age)));
SELECT StudentId, Age, Address FROM [Table] WHERE (StudentId = @StudentId)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT StudentId, Age, Address FROM dbo.[Table]";
        ...
        public virtual int Delete(int Original_StudentId, global::System.Nullable<int> Original_Age) {
        ...
        public virtual int Insert(int StudentId, global::System.Nullable<int> Age, string Address) {
        ...
        public virtual int Update(int StudentId, global::System.Nullable<int> Age, string Address, int Original_StudentId, global::System.Nullable<int> Original_Age) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(global::System.Nullable<int> Age, string Address, int Original_StudentId, global::System.Nullable<int> Original_Age) {
            return this.Update(Original_StudentId, Age, Address, Original_StudentId, Original_Age);
        }
    }
