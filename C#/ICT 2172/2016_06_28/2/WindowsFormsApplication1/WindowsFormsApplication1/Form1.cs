    ...
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if(radioButton1.Checked)
                setdetail(textBox1.Text, textBox2.Text, "Male", textBox3.Text, textBox4.Text, n, A);
            if (radioButton2.Checked)
                setdetail(textBox1.Text, textBox2.Text, "Female", textBox3.Text, textBox4.Text, n, A);
